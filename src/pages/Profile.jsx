  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      ...
      if (achievementData) {
        ...
        // Calculate total points from achievements (using points field stored in database)
    ...
    const handleAchievementsUpdate = () => {
      console.log("🎖️ Achievement update event received - refetching profile...")
      fetchProfile()
    }
                        ...
                        return (
                          <div key={index} className="bg-white dark:bg-gray-800 rounded-lg p-3 flex items-center gap-3 border border-purple-200 dark:border-purple-700">
                            ...
                            <div className="flex-1">
                              <p className="font-semibold text-gray-900 dark:text-white text-sm">{badge?.name || "Unknown"}</p>
                              <p className="text-xs text-gray-600 dark:text-gray-400">{badge?.description || ""}</p>
                            </div>
                            <div className="text-right">
                              <p className="font-bold text-purple-600 dark:text-purple-400">+{badge?.points || 0}</p>
                    ...
                    {Object.entries(ACHIEVEMENT_BADGES).map(([key, badge]) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="text-xs font-bold text-gray-900 dark:text-white">{badge?.name || "Unknown"}</p>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">+{badge?.points || 0} pts</p>
