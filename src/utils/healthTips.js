...
/**
 * Check if the daily tip has been shown today
 */
export const hasTipBeenShownToday = () => {
...
/**
 * Mark the tip as shown today
 */
export const markTipAsShownToday = () => {
  const today = new Date().toDateString()
 ...
 */
export const resetTipTracking = () => {
  localStorage.removeItem("lastTipShownDate")
}
